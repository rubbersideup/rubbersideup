function [d1km d2km]=lldistkm_dw(latlon1,latlon2)
% Derived from lldistkm, available from here:
% http://au.mathworks.com/matlabcentral/fileexchange/38812-latlon-distance
